...
int main(int argc, char **argv)
{
  ...
  */
  ...
  for(int s = 0; s < steps; s++)
  {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    calculate_velocity<<<dimGrid, dimBlock, memory_size>>>(particles_gpu[s & 1], particles_gpu[(s+1) & 1], N, dt);
  ...
  memory_size = red_thr_blc * 4 * sizeof(float);
  
  centerOfMass<<<redGridDim, redBlockDim, memory_size>>>(particles_gpu[steps & 1], &device_com->x, &device_com->y,
