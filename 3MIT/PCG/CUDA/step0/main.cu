...
int main(int argc, char **argv)
{
  ...
  */
  ...
  particles_gpu.weights = device_particles;
  particles_gpu.positions_x = &device_particles[N];
  particles_gpu.positions_y = &device_particles[N * 2];
  particles_gpu.positions_z = &device_particles[N * 3];
  particles_gpu.velocities_x = &device_particles[N * 4];
  particles_gpu.velocities_y = &device_particles[N * 5];
  particles_gpu.velocities_z = &device_particles[N * 6];

  float *device_velocities;
  cudaMalloc<float>(&device_velocities, N * T_VEL_MEM_CNT * sizeof(float));

  t_velocities velocities_gpu
  {
   .x = device_velocities,
   .y = &device_velocities[N],
   .z = &device_velocities[N * 2]
  };

  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //                                       FILL IN: memory transfers (step 0)                                         //
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  cudaMemcpy(device_particles, host_particles, N * T_PAR_MEM_CNT * sizeof(float), cudaMemcpyHostToDevice);
  ...
  for(int s = 0; s < steps; s++)
  {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    cudaMemset(device_velocities, 0, N * T_VEL_MEM_CNT * sizeof(float));
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  float4 comOnGPU = {};
  cudaMemcpy(host_particles, device_particles, N * T_PAR_MEM_CNT * sizeof(float), cudaMemcpyDeviceToHost);
