...
int main(int argc, char **argv)
{
  ...
  */
  MemDesc md(
                   particles_1.positions_x,   1,    0,    // Position in X
                   particles_1.positions_y,   1,    0,    // Position in Y
                   particles_1.positions_z,   1,    0,    // Position in Z
                   particles_1.velocities_x,  1,    0,    // Velocity in X
                   particles_1.velocities_y,  1,    0,    // Velocity in Y
                   particles_1.velocities_z,  1,    0,    // Velocity in Z
                   particles_1.weights,       1,    0,    // Weight
  ...
  std::vector<Particles *> particles { &particles_1, &particles_2 };
  ...
  {
    calculate_velocity(*particles[s & 1], *particles[(s+1) & 1], N, dt);
  ...
  particles[steps & 1]->copyToCPU();
  float4 comOnGPU = centerOfMassGPU(*particles[steps & 1], N);
