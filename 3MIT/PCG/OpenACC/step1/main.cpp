...
int main(int argc, char **argv)
{
  ...
  */
  MemDesc md(
                   particles.positions_x,   1,    0,    // Position in X
                   particles.positions_y,   1,    0,    // Position in Y
                   particles.positions_z,   1,    0,    // Position in Z
                   particles.velocities_x,  1,    0,    // Velocity in X
                   particles.velocities_y,  1,    0,    // Velocity in Y
                   particles.velocities_z,  1,    0,    // Velocity in Z
